...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/update-cart', pizza).then(function (res) {
    ...
    toastr__WEBPACK_IMPORTED_MODULE_0___default().success('Item added to cart', 'Success', {
      timeOut: 1000
    });
  })["catch"](function (err) {
    toastr__WEBPACK_IMPORTED_MODULE_0___default().error('Something went wrong', 'Error', {
      timeOut: 1000
    });
  });
}
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //data-pizza attribute se jo data mil raha
    updateCart(pizza);
  });
});
